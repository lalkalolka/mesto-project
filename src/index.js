...
import {openPopup, closePopup, renderLoading} from './components/utils'
...
formChangeAvatar.addEventListener('submit', function(evt) {
    evt.preventDefault();
    changeAvatar(inputAvatarUrl.value, inputAvatarUrl.value);
})

export {closeByEscape, renderFirstCards}